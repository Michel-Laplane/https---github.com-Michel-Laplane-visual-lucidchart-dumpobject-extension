 ...
 * ```
 */
export type ItemType<Fields extends FieldsStructure> = {
 ...
 */
export type PartialItemType<Fields extends FieldsStructure, PrimaryKey extends keyof Fields> = Pick<ItemType<Fields>, PrimaryKey> & Partial<Omit<ItemType<Fields>, PrimaryKey>>;
export {};
